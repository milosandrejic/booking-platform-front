...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Chip is a compact visual element for tags, selections, and filters. " +
          "Supports filled/outlined, sizes, colors, icons/avatars, clickable and deletable variations.",
      },
    },
  },
  tags: ["autodocs"],
